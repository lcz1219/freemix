...
// 添加请求拦截器，动态设置token
const NO_AUTH_PATHS = ['/login','/qqIdFindUser','/sendEmailCode',
  '/emailLogin','/register', '/captcha','/enable2fa', '/file/upload','/verify2fa','/api/updates/latest','/githubIdFindUser','/qr-login/create','/qr-login/status', '/verify-desktop-token','/share/view/'];
