...
// 添加请求拦截器，动态设置token
const NO_AUTH_PATHS = ['/login','/sendEmailCode','/emailLogin','/register', '/captcha','/enable2fa', '/file/upload','/verify2fa','/githubIdFindUser','/qr-login/create','/qr-login/status', '/verify-desktop-token','/share/view/'];
