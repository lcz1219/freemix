    ...
    <n-layout-content class="main-content-wrapper">
      <div class="main-content">
        ...
        <n-modal 
          ...
          @after-leave="resetGuide">
          <div class="guide-container">
            <!-- 侧边导航 -->
            <div class="guide-sidebar">
              <n-menu
                v-model:value="currentGuideSection"
          ...
          <template #footer>
            <div class="guide-footer">
              <n-button @click="prevGuideSection" :disabled="currentGuideSection === 'welcome'">
                <template #icon>
                  <n-icon><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor"><path d="M15.4,16.6l-4-4l4-4l-1.4-1.4l-5.4,5.4l5.4,5.4L15.4,16.6z"/></svg></n-icon>
                </template>
                上一章节
              </n-button>
              ...
              <n-button @click="nextGuideSection" :disabled="currentGuideSection === 'advanced'">
                下一章节
                <template #icon>
                  <n-icon><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor"><path d="M8.6,16.6l5.4-5.4L8.6,5.8L10,4.4l6.6,6.6L10,17.6L8.6,16.6z"/></svg></n-icon>
                </template>
              </n-button>
